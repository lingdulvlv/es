...
class PaChong extends Command
{
    ...
    public function handle()
    {
        ...
        // $res = $client->request('GET', 'https://laser.ofweek.com/CATList-2400-8100-laser.html');
        // echo $res->getStatusCode();
        // "200"
